...
var createGraphs = function() {
    ...
    for(var i = 0; i < graphs.length; i++){
      ...
      if(graphs[i].get(".mastery-details")[0].innerText != 'No score yet'){
        ...
        htmlString += '<br>';
        htmlString += graphs[i].outerHTML.replace('<svg width="422" height="250" aria-hidden="true">','<svg width="310" height="183" aria-hidden="true" viewBox="0 0 422 250">');
        htmlString += '</div>';
      }
    }
...
loadScript("https://canderegg.gitlab.io/bantam-js/js/bantam-1.2.min.js", createGraphs);
